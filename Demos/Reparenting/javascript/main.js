...
scene.onCreate = function () {
  ...
  for (var i = 0; i < totalStack; i++) {
    var Cube;
    if (i == 0) {
      Cube = scene.addMesh('Link.b3m')
        .setScale(2.5)
        .setTranslationY(300)
        //.setTranslation(rr(-20, 20) + 300, rr(-20, 20), 0)
    } else {
      Cube = Stack[i - 1].addMesh('Link.b3m')
        .setScale(rr(0.7, 0.9))
        .setTranslationZ(100)
  ...
  for (var i = 0; i < totalCubes; i++) {
    ...
    if (i == 0) {
      ...
      Cube = Cubes[i - 1].addMesh('Link.b3m')
        .setScale(rr(0.7, 0.9))
        .setTranslationZ(100)
        //.setTranslation(rr(-20, 20), rr(-20, 20), rr(120, 150))
    }
  ...
  Tester = Cubes[totalCubes - 1].addMesh('Sphere.b3m')
    //.setTranslation(rr(-20, 20), rr(-20, 20), rr(120, 150))
    .setTranslationZ(100)
    .setScale(2)
    .setName("Tester")
  ...
  console.log("WHITE screen button changes sphere's parent one up the link's tree");
  console.log("BLACK screen button changes sphere's parent one down the link's tree");
  console.log("GREEN screen button makes top transparent link the sphere's parent");
  console.log("Tap on any link to make it spin 180° on Z");
  console.log("=======================");
}
