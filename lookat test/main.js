...
function Point(thePointer, theTarget) {
  ...
  var tPointer = thePointer.getTranslation();
  var tTarget = theTarget.getTranslation();
...
scene.onCreate = function () {
  ...
  Pointer = scene.addMesh('Pointer.b3m').setColor('00ff00').setMaterial('Default');
  ...
  Look.onTouchEnd = function () {
    var new_p = [rr(-400, 400), rr(-400, 400), rr(-400, 400)];
    var new_t = [rr(-400, 400), rr(-400, 400), rr(-400, 400)];
